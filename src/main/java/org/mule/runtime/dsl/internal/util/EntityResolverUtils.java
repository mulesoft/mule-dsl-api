...
public class EntityResolverUtils {
  ...
  public static String overrideSystemIdForCompatibility(String publicId, String systemId,
                                                        BiFunction<String, String, Boolean> canResolveEntity) {
    return overrideSystemIdForCompatibility(publicId, systemId, false, canResolveEntity);
  }

  public static String overrideSystemIdForCompatibility(String publicId, String systemId, Boolean runningTests,
                                                        BiFunction<String, String, Boolean> canResolveEntity) {
